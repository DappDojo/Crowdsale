...
contract Crowdsale is Context, ReentrancyGuard {
     ...
     * @param initialWallet Address where collected funds will be forwarded to
     * @param initialToken Address of the token being sold
     */
    constructor (uint256 initialRate, address payable initialWallet, IERC20 initialToken)  {
        require(initialRate > 0, "Crowdsale: rate is 0");
        require(initialWallet != address(0), "Crowdsale: wallet is the zero address");
        require(address(initialToken) != address(0), "Crowdsale: token is the zero address");
